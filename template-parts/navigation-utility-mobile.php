<div class="mobile-utility-container">
    <ul class="utility-navigation">
        ...
        <li>
            <a href="https://connection.newmanministry.com/" class="">
        ...
        <li>
            <a href="https://called.newmanministry.com/" class="">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/called-logo-white-min.png" alt="Called" class="full-white-logo" />
            </a>
        </li>
    </ul>
</div>